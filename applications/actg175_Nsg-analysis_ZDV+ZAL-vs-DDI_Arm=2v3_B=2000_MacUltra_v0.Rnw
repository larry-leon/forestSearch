...
\begin{figure}[h!]
\begin{center}
<<grf_sg_2v3,echo=TRUE,out.height="400px",out.width="400px">>=
par(mfrow=c(1,2))
...
# Only considering drugs and symptom per lasso
df.analysis<-within(df.analysis,{
...
# Set as liberal since LASSO used for dimension reduction
# Primarily for ordering factors
vi.grf.min<-0.1
...
#load(paste0(outpath,"/fsBoot_actg_Arms_2vs3__final.Rdata"))
