...
## 1          2   -22.361327   827.000000   9.320253    22.361327   827.000000
## 2          3    21.962213   258.000000  20.665085   -21.962213   258.000000
## 3          4    17.772840   172.000000  18.488992   -17.772840   172.000000
## 4          5   -81.211528   126.000000  28.148943    81.211528   126.000000
## 5          6   -30.418740   518.000000  11.170055    30.418740   518.000000
## 6          7    37.569013   269.000000  20.568764   -37.569013   269.000000
## 31        10   -40.208330   456.000000  12.993950    40.208330   456.000000
## 41        11     8.826842   181.000000  10.468789    -8.826842   181.000000
## 51        12   -82.358293   112.000000  29.296319    82.358293   112.000000
## 61        13    74.238683   124.000000  26.034823   -74.238683   124.000000
## 7         14   105.243703    64.000000  56.116526  -105.243703    64.000000
## 8         15   -72.038631    81.000000  30.510745    72.038631    81.000000
##     treated.se       diff depth
## 1     9.320253  -44.72265     1
## 2    20.665085   43.92443     1
## 3    18.488992   35.54568     2
## 4    28.148943 -162.42306     2
## 5    11.170055  -60.83748     2
## 6    20.568764   75.13803     2
## 31   12.993950  -80.41666     3
## 41   10.468789   17.65368     3
## 51   29.296319 -164.71659     3
## 61   26.034823  148.47737     3
## 7    56.116526  210.48741     3
## 8    30.510745 -144.07726     3
##   leaf.node control.mean control.size control.se treated.mean treated.size
## 7        14    105.24370     64.00000   56.11653   -105.24370     64.00000
##   treated.se     diff depth
## 7   56.11653 210.4874     3
\end{verbatim}
\begin{alltt}
...
\hlkwd{save}\hlstd{(grf.est,} \hlkwc{file} \hlstd{=} \hlstr{"output/grf_actg_Arms_2vs3_final.Rdata"}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in gzfile(file, "{}wb"{}): cannot open the connection}}\end{kframe}
\end{knitrout}
...
\end{alltt}
\begin{verbatim}
## Minutes and hours for GRF estimation 2.924717 0.04874528
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\end{alltt}
\begin{verbatim}
## Confounders per grf screening v2 v7 v1a v3 v5b v6 v5c v1b v4 v5a 
...
## # of subgroups with events less than criteria: control, experimental 3634 3920 
## # of subgroups meeting all criteria = 1429 
## # of subgroups fitted (Cox model estimable) = 1429 
## Minutes= 0.1171833 
## Number of criteria not met for subgroup evaluation 
## crit.failure
##       0       1       2       3       4 
## 1043809     272    3246     500     748 
## Number of subgroups meeting HR threshold 89 
...
##     v3.1 v5b.0 v5b.1 v6.0 v6.1 v5c.0 v5c.1 v1b.0 v1b.1 v4.0 v4.1 v5a.0 v5a.1
...
## 3:         0.941  88       76       4 4 v1a.0  v3.1 v5b.0  v4.1
##    p.consistency Nsg group.id m.index K   M.1   M.2   M.3   M.4
## 1:         0.950 106       21       1 4 v1a.0 v5b.0  v6.0 v5c.1
## 2:         0.941  88       76       4 4 v1a.0  v3.1 v5b.0  v4.1
...
##    36    17     1    22    16     7    48    23    17    30    19    15     5 
## v1b.1  v4.0  v4.1 v5a.0 v5a.1 
##    33     9    16    10     3
\end{verbatim}
\begin{alltt}
...
\hlkwd{save}\hlstd{(fs.est, df.analysis, FSconfounders.name,} \hlkwc{file} \hlstd{=} \hlstr{"output/fs_actg_Arms_2vs3_final.Rdata"}\hlstd{)}
\end{alltt}
...
\end{alltt}
\begin{verbatim}
## Minutes and hours for FS estimation 0.4067667 0.006779444
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\hlcom{# load('output/fs_actg_Arms_2vs3_final.Rdata')}
...
\end{alltt}
\begin{verbatim}
## Minutes for Boots 2000 83.4098
\end{verbatim}
\begin{alltt}
...
\end{verbatim}
\begin{alltt}
\hlkwd{save}\hlstd{(fs.est, Ystar_mat, resB, H_estimates, Hc_estimates, df_boot_analysis,} \hlkwc{file} \hlstd{=} \hlstr{"output/fsBoot_actg_Arms_2vs3__final.Rdata"}\hlstd{)}
\end{alltt}
...
\end{alltt}
\begin{verbatim}
## Minutes and hours for FS bootstrap 83.43738 1.390623
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Cox model estimates are based on subgroups: H true (knowing the actual subgroup, a-priori); the estimated subgroup $\textbackslash{}\textbackslash{}hat\{H\}$; and 
...
\end{alltt}
\begin{verbatim}
## Minutes and hours to finish 86.77752 1.446292
\end{verbatim}
\begin{alltt}
