...
if(save_output) save(fs_actg_final,df.analysis,FSconfounders.name,file="output/Nsg-fs_actg_Arms_1vs3_final.Rdata")
...
save(fs.est,Ystar_mat,resB,H_estimates,Hc_estimates,df_boot_analysis,file="output/Nsg-fsBoot_actg_Arms_1vs3_final.Rdata")
